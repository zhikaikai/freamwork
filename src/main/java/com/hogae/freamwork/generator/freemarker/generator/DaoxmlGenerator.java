...
@Component
public class DaoxmlGenerator extends AbstractGenerator {

    public Map<String, Object> dataModel;

    public String fileName = "Daoxml.ftl";
    ...
    public DaoxmlGenerator setDataModel(Map<String, Object> dataModel) {
