...
@Component
public class IServiceGenerator extends AbstractGenerator {

    public Map<String, Object> dataModel;

    public String fileName = "IService.ftl";
    ...
    public IServiceGenerator setDataModel(Map<String, Object> dataModel) {
